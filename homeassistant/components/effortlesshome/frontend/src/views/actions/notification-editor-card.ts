...
export class NotificationEditorCard extends LitElement {
  ...
  @property()
  config: effortlesshomeAutomation = {
  ...
  @property()
  item?: effortlesshomeAutomation;

  @property()
  areas!: Dictionary<effortlesshomeArea>;

  @property()
  effortlesshomeConfig?: effortlesshomeConfig;
  ...
  async firstUpdated() {
    ...
    if (this.item) {
      ...
      if (isDefined(area) && !getAreaOptions(this.areas, this.effortlesshomeConfig).includes(area)) area = undefined;
  ...
  protected render(): TemplateResult {
    if (!this.hass || !this.areas || !this.effortlesshomeConfig) return html``;
    return html`
      <div class="heading">
      ...
      <ha-card>
        ...
        ? html`
                <settings-row .narrow=${this.narrow} .large=${true}>
                  ...
                  <effortlesshome-select
                    .hass=${this.hass}
                    .items=${getAreaOptions(this.areas, this.effortlesshomeConfig!).map(e =>
          computeAreaDisplay(e, this.areas, this.effortlesshomeConfig!)
        )}
                    clearable=${true}
