...
import { AlarmEntity, effortlesshomeAutomation, Dictionary, effortlesshomeArea, effortlesshomeConfig, HomeAssistant } from '../../types';
import { SubscribeMixin } from '../../subscribe-mixin';
import { UnsubscribeFunc } from 'home-assistant-js-websocket';

import { commonStyle } from '../../styles';
import { fetchAutomations, saveAutomation, fetchAreas, fetchConfig } from '../../data/websockets';
import { TableColumn, TableFilterConfig } from '../../components/effortlesshome-table';
...
export class AlarmViewActions extends SubscribeMixin(LitElement) {
  ...
  @property()
  automations?: effortlesshomeAutomation[];

  @property()
  areas: Dictionary<effortlesshomeArea> = {};

  @property()
  config!: effortlesshomeConfig;
  ...
  render() {
    ...
    if (this.path.subpage == 'new_notification') {
      ...
      const columns: Dictionary<TableColumn> = {
        type: {
          width: '40px',
          renderer: (item: effortlesshomeAutomation & { area: string }) =>
        ...
        name: {
          ...
          renderer: (item: effortlesshomeAutomation & { area: string }) => html`
        ...
        enabled: {
          ...
          width: '68px',
          align: 'center',
          renderer: (item: effortlesshomeAutomation) => html`
            <ha-switch
  ...
  private getAreaForAutomation = (automation: effortlesshomeAutomation) => {
