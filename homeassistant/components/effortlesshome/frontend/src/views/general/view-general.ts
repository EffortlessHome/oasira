...
import { effortlesshomeConfig, Dictionary, effortlesshomeArea, effortlesshomeAutomation, HomeAssistant } from '../../types';
...
export class AlarmViewGeneral extends SubscribeMixin(LitElement) {
  ...
  @property() data?: Partial<effortlesshomeConfig>;
  ...
  private saveData(changes: Partial<effortlesshomeConfig>) {
