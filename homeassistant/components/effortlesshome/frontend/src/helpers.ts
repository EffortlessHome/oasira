...
import { Dictionary, EArmModes, effortlesshomeModeConfig, HomeAssistant } from './types';
...
export const filterState = (state: string, config: Record<EArmModes, effortlesshomeModeConfig>) => {
