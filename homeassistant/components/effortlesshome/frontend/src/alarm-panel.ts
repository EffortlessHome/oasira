...
import { effortlesshomeUser, Dictionary, HomeAssistant } from './types';
...
export class MyAlarmPanel extends LitElement {
  ...
  @property() userConfig?: Dictionary<effortlesshomeUser>;

  async firstUpdated() {
    window.addEventListener('location-changed', () => {
      if(!window.location.pathname.includes('effortlesshome')) return;
      this.requestUpdate();
    });
