...
def setup_platform(
    ...
    add_entities([GoogleTTSEntity(config, default_language, default_tld)])
...
class GoogleTTSEntity(TextToSpeechEntity):
    ...
    def __init__(self, config_entry: ConfigEntry, lang: str, tld: str) -> None:
        ...
        _LOGGER.info("In google TTS entity")

        self._lang = lang
        self._tld = tld
        self._attr_name = f"Oasira AI TTS"
