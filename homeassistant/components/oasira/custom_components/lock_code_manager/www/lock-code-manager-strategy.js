...
function s(t, e, n, r) {
  var i = c(A(1 & r ? t.prototype : t), e, n);
      ...
      if (null != n) {
        ...
        try {
          if (((o = (n = n.call(t)).next), 0 === e)) {
            ...
            for (
              ;
              !(l = (r = o.call(n)).done) && (u.push(r.value), u.length !== e);
              l = !0
            );
        } catch (t) {
          (s = !0), (i = t);
  ...
  function x(e, n, r) {
    ...
    return function (o, a) {
      ...
      for (r.method = o, r.arg = a; ; ) {
        ...
        "throw" === s.type && ((i = g), (r.method = "throw"), (r.arg = s.arg));
      }
    };
  }
  function P(e, n) {
...
function g(t, e, n) {
  return (
    ...
    (function (t, e) {
      ...
      return m(t);
    })(t, $() ? Reflect.construct(e, n || [], A(t).constructor) : e.apply(t, n))
  );
}
function m(t) {
  if (void 0 === t)
...
var C = globalThis,
  ...
  R = (function () {
    return P(
      function t(e, n, r) {
        if ((O(this, t), (this._$cssResult$ = !0), r !== L))
          throw Error(
    ...
    : function (t) {
        return t instanceof CSSStyleSheet
          ? (function (t) {
              ...
              return (function (t) {
                return new R("string" == typeof t ? t : t + "", void 0, L);
              })(n);
            })(t)
          : t;
      },
  ...
  V = G.trustedTypes,
  F = V ? V.emptyScript : "",
  q = G.reactiveElementPolyfillSupport,
  J = function (t, e) {
    return t;
  },
  K = {
  ...
  Z = { attribute: !0, type: String, converter: K, reflect: !1, hasChanged: Y };
      ...
      [
        ...
        },
        {
          ...
          value: function () {
            var t,
              e = new Map(),
              n = k(this.constructor.elementProperties.keys());
            try {
              for (n.s(); !(t = n.n()).done; ) {
                var r = t.value;
          ...
          value: function (t, e, n) {
            if (void 0 !== t) {
              ...
              if (
                ...
                !(null !== (i = n.hasChanged) && void 0 !== i ? i : Y)(
                  this[t],
                  e,
                ))
              )
      ...
      [
        ...
        },
        {
          ...
          value: function (t, e, n) {
            var r,
              i =
                null !== (r = z(this.prototype, t)) && void 0 !== r
                  ? r
                  : {
                      get: function () {
                        return this[e];
          ...
          value: function () {
            if (!this.hasOwnProperty(J("finalized"))) {
              if (
                ((this.finalized = !0),
                this._$Ei(),
                this.hasOwnProperty(J("properties")))
              ) {
                var t,
                  e = this.properties,
                  n = k([].concat(f(D(e)), f(B(e))));
                try {
                  for (n.s(); !(t = n.n()).done; ) {
                    var r = t.value;
        ...
        },
        {
          ...
          value: function (t) {
            ...
            if (Array.isArray(t)) {
              var n,
                r = k(new Set(t.flat(1 / 0).reverse()));
              try {
                for (r.s(); !(n = r.n()).done; ) {
                  var i = n.value;
                  e.unshift(M(i));
...
(Q.elementStyles = []),
  ...
  (Q[J("elementProperties")] = new Map()),
  (Q[J("finalized")] = new Map()),
  null != q && q({ ReactiveElement: Q }),
...
var X = globalThis,
  ...
  et = tt
    ...
    : void 0,
  nt = "$lit$",
  rt = "lit$".concat(Math.random().toFixed(9).slice(2), "$"),
  it = "?" + rt,
  ot = "<".concat(it, ">"),
  at = document,
  ut = function () {
  ...
  bt = new WeakMap(),
  $t = at.createTreeWalker(at, 129);
function wt(t, e) {
  if (!st(t) || !t.hasOwnProperty("raw"))
      ...
      var a = 0,
        ...
        c = (function (t, e) {
          for (
              ...
              (f = a.lastIndex),
                a === ht
                  ? "!--" === c[1]
                    ...
                    ? (a = dt)
                    : void 0 !== c[2]
                    ? (gt.test(c[2]) && (n = RegExp("</" + c[2], "g")),
                      (a = vt))
                    : void 0 !== c[3] && (a = vt)
                  : a === vt
                  ? ">" === c[0]
                    ? ((a = null !== (d = n) && void 0 !== d ? d : ht),
                      (h = -1))
                    : void 0 === c[1]
                    ? (h = -2)
                    : ((h = a.lastIndex - c[2].length),
                      (s = c[1]),
                      (a = void 0 === c[3] ? vt : '"' === c[3] ? yt : pt))
                  : a === yt || a === pt
                  ? (a = vt)
                  : a === ft || a === dt
                  ? (a = ht)
            ...
            var v = a === vt && t[u + 1].startsWith("/>") ? " " : "";
            o +=
              a === ht
                ? l + ot
                : h >= 0
                ? (i.push(s), l.slice(0, h) + nt + l.slice(h) + rt + v)
                : l + rt + (-2 === h ? u : v);
          }
          return [
            wt(
        ...
        p = h[1];
      if (
        ((this.el = t.createElement(v, n)),
        ($t.currentNode = this.el.content),
        2 === o || 3 === o)
      ) {
        var y = this.el.content.firstChild;
        y.replaceWith.apply(y, f(y.childNodes));
      }
      for (; null !== (r = $t.nextNode()) && s.length < l; ) {
        if (1 === r.nodeType) {
          if (r.hasAttributes()) {
            var g,
              m = k(r.getAttributeNames());
            try {
              for (m.s(); !(g = m.n()).done; ) {
                var _ = g.value;
                if (_.endsWith(nt)) {
                  var b = p[u++],
                    $ = r.getAttribute(_).split(rt),
                    w = /([.?@])?(.*)/.exec(b);
                  s.push({
                    type: 1,
                    index: a,
                  ...
                  _.startsWith(rt) &&
                    (s.push({ type: 6, index: a }), r.removeAttribute(_));
              }
            } catch (t) {
              m.e(t);
            } finally {
          ...
          if (r.data === it) s.push({ type: 2, index: a });
          else
            for (var x = -1; -1 !== (x = r.data.indexOf(rt, x + 1)); )
              s.push({ type: 7, index: a }), (x += rt.length - 1);
        a++;
      }
    },
    null,
...
function kt(t, e) {
  ...
  if (e === mt) return e;
  var s =
      void 0 !== l ? (null === (n = u.o) || void 0 === n ? void 0 : n[l]) : u.l,
    c = lt(e) ? void 0 : e._$litDirective$;
  return (
    (null === (r = s) || void 0 === r ? void 0 : r.constructor) !== c &&
      ...
      void 0 !== l
        ? ((null !== (a = u.o) && void 0 !== a ? a : (u.o = []))[l] = s)
        : (u.l = s)),
    void 0 !== s && (e = kt(t, s._$AS(t, e.values), s, l)),
    e
  );
}
var Et = (function () {
      ...
      [
        ...
        },
        {
          ...
          value: function (t) {
            ...
            $t.currentNode = o;
            for (
              var a = $t.nextNode(), u = 0, l = 0, s = i[0];
              void 0 !== s;
              ...
              if (u === s.index) {
                var h = void 0;
                2 === s.type
                  ? (h = new St(a, a.nextSibling, this, t))
                  : 1 === s.type
                  ? (h = new s.ctor(a, s.name, s.strings, this, t))
                  : 6 === s.type && (h = new Ct(a, this, t)),
                  this._$AV.push(h),
                  (s = i[++l]);
              }
              u !== (null === (c = s) || void 0 === c ? void 0 : c.index) &&
                ((a = $t.nextNode()), u++);
            }
            return ($t.currentNode = at), o;
          },
        },
        {
          key: "p",
  ...
  St = (function () {
    ...
    return P(t, [
      ...
      },
      {
        key: "_",
        value: function (t) {
          this._$AH !== _t && lt(this._$AH)
            ? (this._$AA.nextSibling.data = t)
            : this.T(at.createTextNode(t)),
            (this._$AH = t);
        },
      },
      {
          ...
          var e,
            ...
            i =
              "number" == typeof r
                ? this._$AC(t)
                : (void 0 === r.el &&
                    (r.el = At.createElement(wt(r.h, r.h[0]), this.options)),
                  r);
          if (
      ...
      },
      {
        key: "_$AC",
        value: function (t) {
          var e = bt.get(t.strings);
          return void 0 === e && bt.set(t.strings, (e = new At(t))), e;
        },
      },
      {
        key: "k",
          ...
          value: function (t) {
            ...
            if (void 0 === i)
              ...
              for (t = i[0], a = 0; a < i.length - 1; a++) {
                var s;
                (u = kt(this, l[n + a], e, a)) === mt && (u = this._$AH[a]),
                  o || (o = !lt(u) || u !== this._$AH[a]),
                  u === _t
                    ? (t = _t)
                    : t !== _t &&
                      (t +=
                        (null !== (s = u) && void 0 !== s ? s : "") + i[a + 1]),
                  (this._$AH[a] = u);
              }
            }
            o && !r && this.j(t);
  ...
  xt = (function (t) {
    function e() {
      var t;
      return O(this, e), ((t = g(this, e, arguments)).type = 3), t;
    }
    return (
      _(e, Ot),
      P(e, [
  ...
  Pt = (function (t) {
    function e() {
      var t;
      return O(this, e), ((t = g(this, e, arguments)).type = 4), t;
    }
    return (
      _(e, Ot),
      P(e, [
  ...
  jt = (function (t) {
    function e(t, n, r, i, o) {
      var a;
      return O(this, e), ((a = g(this, e, [t, n, r, i, o])).type = 5), a;
    }
    return (
      _(e, Ot),
      P(e, [
  ...
  Nt = X.litHtmlPolyfillSupport;
null != Nt && Nt(At, St),
  (null !== (r = X.litHtmlVersions) && void 0 !== r
    ? r
    : (X.litHtmlVersions = [])
  ).push("3.2.0");
var Lt = (function (t) {
  function e() {
    ...
    return (
      O(this, e),
      ((t = g(this, e, arguments)).renderOptions = { host: m(t) }),
      (t.o = void 0),
      t
    );
  }
  return (
    ...
    P(e, [
      ...
      },
      {
        ...
        value: function () {
          var t;
          s(e, "connectedCallback", this, 3)([]),
            null === (t = this.o) || void 0 === t || t.setConnected(!0);
        },
      },
      {
        key: "disconnectedCallback",
        value: function () {
          var t;
          s(e, "disconnectedCallback", this, 3)([]),
            null === (t = this.o) || void 0 === t || t.setConnected(!1);
        },
      },
      {
        key: "render",
...
(Lt._$litElement$ = !0),
  ...
  null === (i = globalThis.litElementHydrateSupport) ||
    void 0 === i ||
    i.call(globalThis, { LitElement: Lt });
var Tt = globalThis.litElementPolyfillSupport;
function Rt(t) {
  var e,
...
var Ut = (function (t) {
    function e() {
      return O(this, e), g(this, e, arguments);
    }
    return (
      _(e, Q),
      P(e, null, [
                ...
                return v().wrap(function (t) {
                  for (;;)
                    switch ((t.prev = t.next)) {
                      ...
                      case 7:
                        return (
                          1 === (i = t.sent).length && i.push({ title: "​" }),
                          t.abrupt("return", {
                            title: "Lock Code Manager",
                            views: i,
                          })
  ...
  Dt = ["number_of_uses"],
  Bt = { type: "divider" },
  Wt = ["name", "enabled", "pin", It].concat(Dt, [zt, Mt, Ht]),
  Gt = "fold-entity-row.js";
...
function Ft() {
  return (
    (Ft = y(
      v().mark(function t(e, n, r, i, o) {
        var a, u, l, s, c, h, p, y, g, m;
        return v().wrap(function (t) {
          for (;;)
            switch ((t.prev = t.next)) {
              case 0:
                return (
                  ...
                  Promise.all([
                    e.callWS({
                      config_entry_id: n.entry_id,
                      type: "lock_code_manager/get_slot_calendar_data",
                    }),
                    e.callWS({ type: "lovelace/resources" }),
                  ])
                );
              case 2:
                return (
                  ...
                  (c = r
                    ...
                    .sort(qt)),
                  (h = Object.keys(l.slots).map(function (t) {
...
function qt(t, e) {
  return t.slotNum < e.slotNum
    ...
    : t.slotNum > e.slotNum
    ? 1
    : Wt.indexOf(t.key) < Wt.indexOf(e.key)
    ? -1
    : Wt.indexOf(t.key) > Wt.indexOf(e.key)
    ? 1
    : t.key === e.key &&
      [Ht, Mt, zt].includes(t.key) &&
...
function Kt(t, e) {
  return e.map(function (e) {
    if ([zt, Mt].includes(e.key)) return { entity: e.entity_id };
    var n,
      r = (e.name || e.original_name)
        .replace("Code slot ".concat(e.slotNum), "")
        .replace("  ", " ")
        .replace("  ", " ")
        .trim()
        .replace(t.title, "")
    ...
    return {
      entity: e.entity_id,
      name: ((n = r), n.charAt(0).toUpperCase() + n.slice(1)),
    };
  });
}
function Yt(t, e, n, r, i) {
  return {
    cards: [
      { content: "## Code Slot ".concat(e.slotNum), type: "markdown" },
      {
        entities: [].concat(
          f(Kt(t, e.mainEntities)),
          [
            Bt,
            { entity: e.pinActiveEntity.entity_id, name: "PIN active" },
            { entity: e.codeEventEntity.entity_id, name: "PIN last used" },
          ],
          f(Xt(t, e.conditionEntities, e.calendarEntityId, "Conditions", n)),
          f(i ? Qt(t, e.inSyncEntities, "Locks in sync", n) : []),
          f(r ? Qt(t, e.codeSensorEntities, "Code slot sensors", n) : []),
        ),
...
function Zt(t, e, n, r) {
  ...
  n.filter(function (t) {
    ...
    t.key === Mt
      ...
      : Dt.includes(t.key)
      ? a.push(t)
      : [It, zt].includes(t.key) || o.push(t);
  });
  var s = n.find(function (t) {
    return t.slotNum === e && t.key === It;
  });
  return {
    calendarEntityId: r.slots[e],
    codeEventEntity: i,
    codeSensorEntities: u,
    conditionEntities: a,
    inSyncEntities: l,
    mainEntities: o,
    pinActiveEntity: s,
...
function Qt(t, e, n, r) {
  ...
  return r
    ? [
        ...
        {
          entities: i,
          head: { label: n, type: "section" },
          type: "custom:fold-entity-row",
        },
      ]
    : [{ label: n, type: "section" }].concat(f(i));
}
function Xt(t, e, n, r, i) {
  if (0 === e.length && null == n) return [];
  var o = Kt(t, e);
  return (
    null != n && o.unshift({ entity: n }),
    i
      ? [
          Bt,
          {
            entities: o,
            head: { label: r, type: "section" },
            type: "custom:fold-entity-row",
          },
        ]
      : [{ label: r, type: "section" }].concat(f(o))
  );
}
var te = (function (t) {
  function e() {
                  ...
                  for (;;)
                    switch ((t.prev = t.next)) {
                      case 0:
                        if (
                          ((r = e.config_entry_id),
                          (i = e.config_entry_title),
                          "NOT_RUNNING" !== n.config.state)
                        ) {
                          t.next = 3;
                          break;
                        }
                        ...
                        return (
                          ...
                          t.abrupt(
                            ...
                            Vt(
                              ...
                              l,
                              s,
                              null !== (o = e.include_code_slot_sensors) &&
                                void 0 !== o &&
                                o,
                              null === (a = e.include_in_sync_sensors) ||
                                void 0 === a ||
                                a,
                            ),
                          )
...
customElements.define("ll-strategy-dashboard-lock-code-manager", Ut),
  customElements.define("ll-strategy-view-lock-code-manager", te);
