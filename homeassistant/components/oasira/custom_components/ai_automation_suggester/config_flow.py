...
class ProviderValidator:
    ...
    async def validate_custom_openai(
...
class AIAutomationConfigFlow(config_entries.ConfigFlow, domain=DOMAIN):
    ...
    async def async_step_openai(self, user_input: dict[str, Any] | None = None):
        ...
        if user_input is not None:
            ...
            error_message = await self.validator.validate_openai(
            ...
            if error_message is None:
                ...
                return self.async_create_entry(
                    title="AI Automation Suggester (OpenAI)", data=self.data
                )
            ...
            data_schema=vol.Schema(
                {
                    ...
                    vol.Optional(
                        CONF_OPENAI_MODEL, default=DEFAULT_MODELS["OpenAI"]
                    ): str,
    ...
    async def async_step_anthropic(self, user_input: dict[str, Any] | None = None):
        ...
        if user_input is not None:
            ...
            error_message = await self.validator.validate_anthropic(
                api_key=user_input[CONF_ANTHROPIC_API_KEY], model=model
            )

            if error_message is None:
                self.data.update(user_input)
                return self.async_create_entry(
                    title="AI Automation Suggester (Anthropic)", data=self.data
                )
            errors["base"] = "api_error"
            description_placeholders["error_message"] = error_message
    ...
    async def async_step_google(self, user_input: dict[str, Any] | None = None):
        ...
        if user_input is not None:
            ...
            error_message = await self.validator.validate_google(
                api_key=user_input[CONF_GOOGLE_API_KEY], model=model
            )

            if error_message is None:
                self.data.update(user_input)
                return self.async_create_entry(
                    title="AI Automation Suggester (Google)", data=self.data
                )
            errors["base"] = "api_error"
            description_placeholders["error_message"] = error_message
            ...
            data_schema=vol.Schema(
                {
                    ...
                    vol.Optional(
                        CONF_GOOGLE_MODEL, default=DEFAULT_MODELS["Google"]
                    ): str,
                    vol.Optional(CONF_MAX_TOKENS, default=DEFAULT_MAX_TOKENS): vol.All(
                        vol.Coerce(int), vol.Range(min=100)
                    ),
    ...
    async def async_step_groq(self, user_input: dict[str, Any] | None = None):
        ...
        if user_input is not None:
            self.validator = ProviderValidator(self.hass)
            error_message = await self.validator.validate_groq(
                user_input[CONF_GROQ_API_KEY]
            )

            if error_message is None:
                self.data.update(user_input)
                return self.async_create_entry(
                    title="AI Automation Suggester (Groq)", data=self.data
                )
            errors["base"] = "api_error"
            description_placeholders["error_message"] = error_message
    ...
    async def async_step_localai(self, user_input: dict[str, Any] | None = None):
        ...
        if user_input is not None:
            ...
            if error_message is None:
                self.data.update(user_input)
                return self.async_create_entry(
                    title="AI Automation Suggester (LocalAI)", data=self.data
                )
            errors["base"] = "api_error"
            description_placeholders["error_message"] = error_message
            ...
            data_schema=vol.Schema(
                {
                    ...
                    vol.Optional(
                        CONF_LOCALAI_MODEL, default=DEFAULT_MODELS["LocalAI"]
                    ): str,
                    vol.Optional(CONF_MAX_TOKENS, default=DEFAULT_MAX_TOKENS): vol.All(
                        vol.Coerce(int), vol.Range(min=100)
                    ),
    ...
    async def async_step_ollama(self, user_input: dict[str, Any] | None = None):
        ...
        if user_input is not None:
            ...
            if error_message is None:
                self.data.update(user_input)
                return self.async_create_entry(
                    title="AI Automation Suggester (Ollama)", data=self.data
                )
            errors["base"] = "api_error"
            description_placeholders["error_message"] = error_message
            ...
            data_schema=vol.Schema(
                {
                    ...
                    vol.Optional(
                        CONF_OLLAMA_MODEL, default=DEFAULT_MODELS["Ollama"]
                    ): str,
                    vol.Optional(CONF_MAX_TOKENS, default=DEFAULT_MAX_TOKENS): vol.All(
                        vol.Coerce(int), vol.Range(min=100)
                    ),
    ...
    async def async_step_custom_openai(self, user_input: dict[str, Any] | None = None):
        ...
        if user_input is not None:
            ...
            if error_message is None:
                self.data.update(user_input)
                return self.async_create_entry(
                    title="AI Automation Suggester (Custom OpenAI)", data=self.data
                )
            errors["base"] = "api_error"
            description_placeholders["error_message"] = error_message
            ...
            data_schema=vol.Schema(
                {
                    ...
                    vol.Optional(
                        CONF_CUSTOM_OPENAI_MODEL,
                        default=DEFAULT_MODELS["Custom OpenAI"],
                    ): str,
                    vol.Optional(CONF_MAX_TOKENS, default=DEFAULT_MAX_TOKENS): vol.All(
                        vol.Coerce(int), vol.Range(min=100)
                    ),
        ...
        if provider == "OpenAI":
            ...
            options[
                vol.Optional(
                    ...
                    default=self.config_entry.data.get(
                        CONF_OPENAI_MODEL, DEFAULT_MODELS["OpenAI"]
                    ),
                )
            ] = str
            ...
            options[
                vol.Optional(
                    CONF_ANTHROPIC_MODEL,
                    default=self.config_entry.data.get(
                        CONF_ANTHROPIC_MODEL, DEFAULT_MODELS["Anthropic"]
                    ),
                )
            ] = str
            ...
            options[
                vol.Optional(
                    CONF_GOOGLE_MODEL,
                    default=self.config_entry.data.get(
                        CONF_GOOGLE_MODEL, DEFAULT_MODELS["Google"]
                    ),
                )
            ] = str
        elif provider == "Groq":
            ...
            options[
                vol.Optional(
                    CONF_GROQ_MODEL,
                    default=self.config_entry.data.get(
                        CONF_GROQ_MODEL, DEFAULT_MODELS["Groq"]
                    ),
                )
            ] = str
            ...
            options[
                vol.Optional(
                    CONF_LOCALAI_MODEL,
                    default=self.config_entry.data.get(
                        CONF_LOCALAI_MODEL, DEFAULT_MODELS["LocalAI"]
                    ),
                )
            ] = str
            ...
            options[
                vol.Optional(
                    CONF_OLLAMA_MODEL,
                    default=self.config_entry.data.get(
                        CONF_OLLAMA_MODEL, DEFAULT_MODELS["Ollama"]
                    ),
                )
            ] = str
            ...
            options[
                vol.Optional(
                    CONF_CUSTOM_OPENAI_MODEL,
                    default=self.config_entry.data.get(
                        CONF_CUSTOM_OPENAI_MODEL, DEFAULT_MODELS["Custom OpenAI"]
                    ),
                )
            ] = str
