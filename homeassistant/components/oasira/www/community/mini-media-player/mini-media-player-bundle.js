...
function t(t, e, i, r) {
  ...
  if ("object" == typeof Reflect && "function" == typeof Reflect.decorate)
    ...
    for (var a = t.length - 1; a >= 0; a--)
      (o = t[a]) && (s = (n < 3 ? o(s) : n > 3 ? o(e, i, s) : o(e, i)) || s);
        ...
        if ((h++, 1 === t.nodeType)) {
          if (t.hasAttributes()) {
            const e = t.attributes,
              { length: i } = e;
            let r = 0;
            for (let t = 0; t < i; t++) a(e[t].name, "$lit$") && r++;
            for (; r-- > 0; ) {
              const e = d[p],
                i = u.exec(e)[2],
                r = i.toLowerCase() + "$lit$",
          ...
          "TEMPLATE" === t.tagName && (o.push(t), (s.currentNode = t.content));
          ...
          if (e.indexOf(r) >= 0) {
            ...
            "" === o[s] ? (r.insertBefore(c(), t), i.push(t)) : (t.data = o[s]),
              (p += s);
          }
        } else if (8 === t.nodeType)
          if (t.data === r) {
            const e = t.parentNode;
            (null !== t.previousSibling && h !== l) ||
              (h++, e.insertBefore(c(), t)),
              (l = h),
              this.parts.push({ type: "node", index: h }),
...
function h(t, e) {
  ...
  for (; o.nextNode(); ) {
    ...
    for (
      ...
      (s.index = null !== u ? -1 : s.index - l), (n = d(r, n)), (s = r[n]);
  }
...
class x {
  ...
  getHTML() {
    ...
    for (let n = 0; n < t; n++) {
      ...
      e +=
        null === a
          ? t + (i ? w : o)
          : t.substr(0, a.index) + a[1] + a[2] + "$lit$" + a[3] + r;
    }
  ...
  getTemplateElement() {
    ...
    let e = this.getHTML();
    return void 0 !== b && (e = b.createHTML(e)), (t.innerHTML = e), t;
  }
}
/**
 * @license
...
class $ {
  ...
  _getValue() {
    ...
    for (let o = 0; o < e; o++) {
      ...
      if (void 0 !== e) {
        const t = e.value;
        if (k(t) || !S(t)) r += "string" == typeof t ? t : String(t);
    ...
    for (const o of t)
      (i = e[r]),
        void 0 === i &&
          ...
          e.push(i),
          0 === r ? i.appendIntoPart(this) : i.insertAfterPart(e[r - 1])),
        i.setValue(o),
        i.commit(),
        r++;
...
const V = (t) =>
  t &&
  (O ? { capture: t.capture, passive: t.passive, once: t.once } : t.capture);
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 */ function N(t) {
  ...
  const o = t.strings.join(r);
  return (
    (i = e.keyString.get(o)),
    void 0 === i &&
      ((i = new s(t, t.getTemplateElement())), e.keyString.set(o, i)),
 ...
 */
(class {
  handleAttributeExpressions(t, e, i, r) {
    const o = e[0];
    if ("." === o) {
      return new E(t, e.slice(1), i).parts;
    }
    if ("@" === o) return [new A(t, e.slice(1), r.eventContext)];
    if ("?" === o) return [new M(t, e.slice(1), i)];
    return new $(t, e, i).parts;
  }
...
const U = (t) => (e) => {
    ...
    if (((n = o.keyString.get(a)), void 0 === n)) {
      const i = e.getTemplateElement();
      z && window.ShadyCSS.prepareTemplateDom(i, t),
        (n = new s(e, i)),
        o.keyString.set(a, n);
    }
      ...
      ? (function (t, e, i = null) {
          ...
          for (; n.nextNode(); )
            for (
              l++,
                n.currentNode === i &&
                  ((a = p(e)), i.parentNode.insertBefore(e, i));
              -1 !== s && o[s].index === l;

            ) {
              if (a > 0) {
                for (; -1 !== s; ) (o[s].index += a), (s = d(o, s));
                return;
              }
              s = d(o, s);
            }
...
const G = {
  ...
  H = (t, e) => e !== t && (e == e || t == t),
  W = { attribute: !0, type: String, converter: G, reflect: !1, hasChanged: H };
class Z extends HTMLElement {
  ...
  static get observedAttributes() {
    ...
    return (
      this._classProperties.forEach((e, i) => {
        const r = this._attributeNameForProperty(i, e);
        void 0 !== r && (this._attributeToPropertyMap.set(r, i), t.push(r));
      }),
      t
    );
  }
  ...
  static getPropertyDescriptor(t, e, i) {
    return {
      ...
      set(r) {
        const o = this[t];
        (this[e] = r), this.requestUpdateInternal(t, o, i);
      },
      configurable: !0,
      enumerable: !0,
    };
  ...
  static _propertyValueToAttribute(t, e) {
    ...
    const i = e.type,
      r = e.converter;
    return ((r && r.toAttribute) || G.toAttribute)(t, i);
  }
  initialize() {
    (this._updateState = 0),
  ...
  _propertyToAttribute(t, e, i = W) {
    const r = this.constructor,
      o = r._attributeNameForProperty(t, i);
    if (void 0 !== o) {
      const t = r._propertyValueToAttribute(e, i);
      if (void 0 === t) return;
  ...
  _attributeToProperty(t, e) {
    ...
    if (void 0 !== r) {
      ...
      (this._updateState = 16 | this._updateState),
        (this[r] = i._propertyValueFromAttribute(e, t)),
  ...
  requestUpdateInternal(t, e, i) {
    ...
    if (void 0 !== t) {
      ...
      (i = i || o.getPropertyOptions(t)),
        o._valueHasChanged(this[t], e, i.hasChanged)
  ...
  static _getUniqueStyles() {
    ...
    if (Array.isArray(t)) {
      const e = (t, i) =>
        ...
        i = e(t, new Set()),
        r = [];
      i.forEach((t) => r.unshift(t)), (this._styles = r);
  ...
  (ot.render = (t, e, r) => {
    ...
    if (
      (((t, e, r) => {
        ...
        void 0 === o &&
          (i(e, e.firstChild),
          j.set(e, (o = new C(Object.assign({ templateFactory: N }, r)))),
          o.appendInto(e)),
          o.setValue(t),
          o.commit();
      })(t, l, Object.assign({ templateFactory: U(o) }, r)),
      a)
    ) {
      const t = j.get(l);
      j.delete(l);
      const r = t.value instanceof y ? t.value.template : void 0;
      F(o, l, r), i(e, e.firstChild), e.appendChild(l), j.set(e, t);
    }
    !n && s && window.ShadyCSS.styleElement(e.host);
  }),
  (ot.shadowRootOptions = { mode: "open" });
/**
 * @license
...
const st = new WeakMap(),
  at = g((t) => (e) => {
    ...
    void 0 === o &&
      ...
      st.set(e, (o = new Set())));
    const n = r.classList || new nt(r);
    o.forEach((e) => {
      e in t || (n.remove(e), o.delete(e));
    });
    for (const e in t) {
      const i = t[e];
      i != o.has(e) && (i ? (n.add(e), o.add(e)) : (n.remove(e), o.delete(e)));
    }
  ...
  ct = g((t) => (e) => {
    ...
    let o = lt.get(e);
    void 0 === o &&
      ((r.cssText = i.strings.join(" ")), lt.set(e, (o = new Set()))),
      o.forEach((e) => {
        e in t ||
          (o.delete(e),
          -1 === e.indexOf("-") ? (r[e] = null) : r.removeProperty(e));
      });
    for (const e in t)
      o.add(e), -1 === e.indexOf("-") ? (r[e] = t[e]) : r.setProperty(e, t[e]);
  });
var ut = (function () {
...
var mt = [
  ...
  _t = function (t) {
    return (t && t.ownerDocument && t.ownerDocument.defaultView) || pt;
  },
  yt = $t(0, 0, 0, 0);
function bt(t) {
...
function xt(t) {
  ...
  if (
    ("border-box" === r.boxSizing &&
      (Math.round(a + n) !== e && (a -= wt(r, "left", "right") + n),
      Math.round(l + s) !== i && (l -= wt(r, "top", "bottom") + s)),
    !(function (t) {
      return t === _t(t).document.documentElement;
    })(t))
  ) {
  ...
  return $t(o.left, o.top, a, l);
}
var kt =
  "undefined" != typeof SVGGraphicsElement
    ? function (t) {
        return t instanceof _t(t).SVGGraphicsElement;
      }
    : function (t) {
        return t instanceof _t(t).SVGElement && "function" == typeof t.getBBox;
      };
function St(t) {
  return ht
    ? kt(t)
...
var Pt = (function () {
  ...
  Ct = function (t, e) {
    ...
    vt(this, { target: t, contentRect: i });
  },
  Mt = (function () {
    function t(t, e, i) {
      if (
        ((this.activeObservations_ = []),
        (this.observations_ = new ut()),
        "function" != typeof t)
      )
        throw new TypeError(
        ...
        if (this.hasActive()) {
          var t = this.callbackCtx_,
            e = this.activeObservations_.map(function (t) {
              return new Ct(t.target, t.broadcastRect());
            });
  ...
  Et = "undefined" != typeof WeakMap ? new WeakMap() : new ut(),
  Tt = function t(e) {
    if (!(this instanceof t))
      throw new TypeError("Cannot call a class as a function.");
    if (!arguments.length)
      throw new TypeError("1 argument required, but only 0 present.");
    var i = ft.getInstance(),
      r = new Mt(e, i, this);
    Et.set(this, r);
  };
...
var Ot = void 0 !== pt.ResizeObserver ? pt.ResizeObserver : Tt;
const At = {
    repeat: !0,
    shuffle: !0,
    power_state: !0,
  ...
  Vt = { OFF: "off", ALL: "all", ONE: "one" },
  Nt = "mdi:chevron-down",
  Lt = "mdi:speaker-multiple",
  jt = { true: "mdi:volume-off", false: "mdi:volume-high" },
  Dt = "mdi:skip-next",
  It = { true: "mdi:pause", false: "mdi:play" },
  Rt = "mdi:power",
  zt = "mdi:skip-previous",
  Ut = "mdi:shuffle",
  qt = {
    [Vt.OFF]: "mdi:repeat-off",
    [Vt.ONE]: "mdi:repeat-once",
    [Vt.ALL]: "mdi:repeat",
  },
  Bt = { true: "mdi:stop", false: "mdi:play" },
  Ft = "mdi:volume-minus",
  Gt = "mdi:volume-plus",
  Ht = "mdi:fast-forward",
  Wt = "mdi:rewind",
  ...
  Jt = ["media_duration", "media_position", "media_position_updated_at"],
  Xt = [
    { attr: "media_title" },
    { attr: "media_artist" },
...
!(function (t) {
  (t.MORE_INFO = "more-info"),
    (t.NAVIGATE = "navigate"),
    (t.CALL_SERVICE = "call-service"),
    (t.URL = "url"),
    (t.FIRE_DOM_EVENT = "fire-dom-event"),
    (t.NONE = "none");
})(ie || (ie = {}));
const re = (t) => {
  var e;
  ((t) => {
    ...
    if ("media_player" !== t.entity.split(".")[0])
    ...
    Object.assign(
      {
        ...
        sound_mode: "default",
        toggle_power: !0,
        tap_action: { action: ie.MORE_INFO },
        jump_amount: 10,
      },
      t,
    ),
    {
      hide: Object.assign(Object.assign({}, At), t.hide),
      ...
      shortcuts: Object.assign({ label: "Shortcuts..." }, t.shortcuts),
      max_volume: null !== (e = Number(t.max_volume)) && void 0 !== e ? e : 100,
      min_volume: Number(t.min_volume) || 0,
    },
  );
  return (
    (i.collapse = i.hide.controls || i.hide.volume),
    (i.info = i.collapse && "scroll" !== i.info ? "short" : i.info),
    (i.flow = i.hide.icon && i.hide.name && i.hide.info),
    i
  );
};
var oe;
...
class ne {
  constructor(t, e, i) {
    (this.hass = t || {}),
      ...
      (this.entity = i || {}),
      (this.state = i.state),
      (this._entityId = (i && i.entity_id) || this.config.entity),
      (this._attr = i.attributes || {}),
  ...
  get isPaused() {
    return this.state === oe.PAUSED;
  }
  get isPlaying() {
    return this.state === oe.PLAYING;
  }
  get isIdle() {
    return this.state === oe.IDLE;
  }
  get isStandby() {
    return this.state === oe.STANDBY;
  }
  get isUnavailable() {
    return this.state === oe.UNAVAILABLE;
  }
  get isOff() {
    return this.state === oe.OFF;
  }
  get isActive() {
    return (!this.isOff && !this.isUnavailable && !this.idle) || !1;
  }
  get assumedState() {
    return this._attr.assumed_state || !1;
  }
  get shuffle() {
    return this._attr.shuffle || !1;
  }
  get repeat() {
    return this._attr.repeat || Vt.OFF;
  }
  get content() {
  ...
  get group() {
    return this.platform === Kt
      ? this._attr.sync_group || []
      : this.platform === te || this.platform === ee || this.platform === Yt
      ? this._attr.group_members || []
      : this._attr[`${this.platform}_group`] || [];
  }
  get platform() {
    return this.config.speaker_group.platform;
  }
  get master() {
    return (this.supportsMaster && this.group[0]) || this._entityId;
  }
  get isMaster() {
  ...
  get muted() {
    return this._attr.is_volume_muted || !1;
  }
  get vol() {
  ...
  get mediaInfo() {
    return Xt.map((t) =>
      Object.assign({ text: this._attr[t.attr], prefix: "" }, t),
    ).filter((t) => t.text);
  }
  get hasProgress() {
    return (
      ...
      !this.idle &&
      Jt.every((t) => t in this._attr)
    );
  }
  get supportsPrev() {
    return (
      !!this._attr.supported_features &&
      (16 | this._attr.supported_features) === this._attr.supported_features
    );
  }
  get supportsNext() {
    return (
      !!this._attr.supported_features &&
      (32 | this._attr.supported_features) === this._attr.supported_features
    );
  }
  get progress() {
    return this.isPlaying
      ? this.position + (Date.now() - new Date(this.updatedAt).getTime()) / 1e3
      : this.position;
  }
  get idleView() {
    ...
    return (
      !!(
        ((null == t ? void 0 : t.when_idle) && this.isIdle) ||
        ((null == t ? void 0 : t.when_standby) && this.isStandby) ||
        ((null == t ? void 0 : t.when_paused) && this.isPaused)
      ) ||
      (!(
        !this.updatedAt ||
        !(null == t ? void 0 : t.after) ||
        this.isPlaying
      ) &&
  ...
  checkIdleAfter(t) {
    ...
    return (this.idle = e > 60 * t), (this._active = this.isActive), this.idle;
  }
  get supportsShuffle() {
    return void 0 !== this._attr.shuffle;
  }
  get supportsRepeat() {
    return void 0 !== this._attr.repeat;
  }
  get supportsMute() {
    return void 0 !== this._attr.is_volume_muted;
  }
  get supportsVolumeSet() {
    return void 0 !== this._attr.volume_level;
  }
  get supportsMaster() {
    return this.platform !== Kt && this.config.speaker_group.supports_master;
  }
  async fetchArtwork() {
    const t = this._attr.entity_picture_local
  ...
  toggleMute(t) {
    this.config.speaker_group.sync_volume
      ...
      : this.callService(t, "volume_mute", { is_volume_muted: !this.muted });
  }
  toggleShuffle(t) {
    this.callService(t, "shuffle_set", { shuffle: !this.shuffle });
  }
  toggleRepeat(t) {
    const e = Object.values(Vt),
      { length: i } = e,
      r = e.indexOf(this.repeat) - 1,
      o = e[(r - (1 % i) + i) % i];
    this.callService(t, "repeat_set", { repeat: o });
  }
  setSource(t, e) {
    this.callService(t, "select_source", { source: e });
  }
  setMedia(t, e) {
    this.callService(t, "play_media", Object.assign({}, e));
  }
  play(t) {
    this.callService(t, "media_play");
  }
  pause(t) {
    this.callService(t, "media_pause");
  }
  playPause(t) {
  ...
  volumeUp(t) {
    this.supportsVolumeSet &&
    this.config.volume_step &&
    this.config.volume_step > 0
  ...
  jump(t, e) {
    const i = this.progress + e,
      r = Math.min(Math.max(i, 0), Number(this.mediaDuration) || i);
    this.callService(t, "media_seek", { seek_position: r });
  }
  setVolume(t, e) {
    this.config.speaker_group.sync_volume && this.config.speaker_group.entities
      ? this.group.forEach((i) => {
          var r;
          const o =
            null === (r = this.config.speaker_group.entities) || void 0 === r
              ? void 0
              : r.find((t) => t.entity_id === i);
          if (void 0 === o) return;
          let n = e;
          o.volume_offset &&
            ((n += o.volume_offset / 100), n > 1 && (n = 1), n < 0 && (n = 0)),
            this.callService(t, "volume_set", {
              entity_id: i,
              volume_level: n,
            });
  ...
  handleGroupChange(t, e, i) {
    const { platform: r } = this,
      o = { entity_id: e };
    if (i)
      switch (((o.master = this._entityId), r)) {
        case Qt:
        ...
        case Kt:
          return this.callService(
            t,
            "sync",
            { entity_id: this._entityId, other_player: e },
            Kt,
          );
        case te:
        case Yt:
          return this.callService(
            t,
            "join",
            { entity_id: this._entityId, group_members: e },
            te,
          );
        case ee:
          return this.callService(
            ...
            {
              entity_id: this._entityId,
              group_members: this.group.concat("string" == typeof e ? [e] : e),
            },
            te,
          );
        default:
          return this.callService(t, "join", o, r);
      }
    else
      switch (r) {
        case Qt:
        ...
        case Kt:
          return this.callService(t, "unsync", o, Kt);
        case te:
        case Yt:
          return this.callService(t, "unjoin", { entity_id: e }, te);
        case ee:
          return this.callService(
            t,
            "unjoin",
            { entity_id: "string" == typeof e ? e : e[0] },
            te,
          );
        default:
          return this.callService(t, "unjoin", o, r);
      }
  }
  handleSoundtouch(t, e, i) {
    return this.callService(t, e, { master: this.master, slaves: i }, Qt, !0);
  }
  toggleScript(t, e, i = {}) {
    const [, r] = e.split(".");
    this.callService(t, r, Object.assign({}, i), "script");
  }
  toggleService(t, e, i = {}) {
    t.stopPropagation();
    const [r, o] = e.split(".");
    this.hass.callService(r, o, Object.assign({}, i));
  }
  callService(t, e, i, r = "media_player", o = !1) {
    t.stopPropagation(),
      this.hass.callService(
        r,
        e,
        Object.assign(
          Object.assign({}, !o && { entity_id: this._entityId }),
          i,
        ),
      );
  }
...
var le = (t, e, i, r, o) => {
  ...
  switch (r.action) {
    case "more-info":
      (n = new Event("hass-more-info", { composed: !0 })),
        (n.detail = { entityId: r.entity || o }),
        t.dispatchEvent(n);
      break;
    case "navigate":
      if (!r.navigation_path) return;
      window.history.pushState(null, "", r.navigation_path),
        (n = new Event("location-changed", { composed: !0 })),
        (n.detail = { replace: !1 }),
        window.dispatchEvent(n);
      break;
    case "call-service": {
      if (!r.service) return;
      const [t, i] = r.service.split(".", 2),
        o = { ...r.service_data };
      e.callService(t, i, o);
      break;
    }
    case "url":
      if (!r.url) return;
      r.new_tab ? window.open(r.url, "_blank") : (window.location.href = r.url);
      break;
    case "fire-dom-event":
      (n = new Event("ll-custom", { composed: !0, bubbles: !0 })),
        (n.detail = r),
        t.dispatchEvent(n);
  }
  r.haptic &&
    ((t, e) => {
      const i = new Event("haptic", { composed: !0 });
      (i.detail = { haptic: e }), t.dispatchEvent(i);
    })(t, r.haptic);
};
var ce,
  ue,
        ...
        (i = function () {
          return (function (t) {
            ...
            function i(r) {
              ...
              return (
                t[r].call(o.exports, o, o.exports, i), (o.l = !0), o.exports
              );
            }
            return (
              (i.m = t),
            ...
            function (t, e, i) {
              Object.defineProperty(e, "__esModule", { value: !0 }),
                (e.assignDeep = e.mapValues = void 0),
            ...
            function (t, e, i) {
              ...
              var o = i(7),
                ...
                a = (function () {
                  function t(e, i) {
                    (this._src = e),
                      (this.opts = s.assignDeep({}, t.DefaultOpts, i));
                  }
                  return (
                    (t.use = function (t) {
                      this._pipeline = t;
                    ...
                    (t.prototype._process = function (e, i) {
                      this.opts.quantizer, e.scaleDown(this.opts);
                      var r = o.buildProcessOptions(this.opts, i);
                      return t._pipeline.process(e.getImageData(), r);
                    }),
                    ...
                    (t.prototype.getPalette = function () {
                      ...
                      return n
                        ...
                        .then(function (t) {
                          return n.remove(), o && o(void 0, t), t;
                        })
                        .catch(function (t) {
                          return n.remove(), o && o(t), Promise.reject(t);
                        });
                    }),
            ...
            function (t, e, i) {
              Object.defineProperty(e, "__esModule", { value: !0 }),
                (e.applyFilters = e.ImageBase = void 0);
              var r = (function () {
                function t() {}
                return (
                  ...
                  return (
                    (t.applyFilters = function (t, e) {
                      return e.length > 0
                        ? t.filter(function (t) {
                            for (
                              var i = t.r, r = t.g, o = t.b, n = 0;
                              n < e.length;
                              n++
                            )
                              if (!e[n](i, r, o, 255)) return !1;
                            return !0;
                          })
                        : t;
                    }),
            ...
            function (t, e, i) {
              function r(t) {
                ...
                if (!e)
                  throw new RangeError("'" + t + "' is not a valid hex color");
              ...
              function o(t, e, i) {
                return (
                  ...
                  (e =
                    e > 0.04045
                      ? Math.pow((e + 0.005) / 1.055, 2.4)
                      : e / 12.92),
                  (i =
                    i > 0.04045
                      ? Math.pow((i + 0.005) / 1.055, 2.4)
                      : i / 12.92),
                  [
                    0.4124 * (t *= 100) +
                      0.3576 * (e *= 100) +
                      0.1805 * (i *= 100),
                    0.2126 * t + 0.7152 * e + 0.0722 * i,
                    0.0193 * t + 0.1192 * e + 0.9505 * i,
                  ]
                );
              }
              function n(t, e, i) {
              ...
              function a(t, e) {
                var i = t[0],
                  ...
                  m = Math.sqrt(l * l + c * c + u * u),
                  g =
                    Math.sqrt(m) >
                    Math.sqrt(Math.abs(p)) + Math.sqrt(Math.abs(d))
            ...
            function (t, e, i) {
              var r =
                ...
                o = r(i(6)),
                n = r(i(9));
              (o.default.DefaultOpts.ImageClass = n.default),
                (t.exports = o.default);
            },
            function (t, e, i) {
              var r =
              ...
              Object.defineProperty(e, "__esModule", { value: !0 });
              var o = r(i(1));
              (o.default.DefaultOpts.quantizer = "mmcq"),
                (o.default.DefaultOpts.generators = ["default"]),
                (o.default.DefaultOpts.filters = ["default"]),
                (e.default = o.default);
            },
            function (t, e, i) {
              Object.defineProperty(e, "__esModule", { value: !0 }),
                (e.buildProcessOptions = void 0);
              var r = i(0);
              e.buildProcessOptions = function (t, e) {
                var i = t.colorCount,
                  ...
                  s = t.filters,
                  a = { colorCount: i },
                  l = "string" == typeof o ? { name: o, options: {} } : o;
                return (
                  (l.options = r.assignDeep({}, a, l.options)),
                  r.assignDeep(
                    {},
                    { quantizer: l, generators: n, filters: s },
                    e,
                  )
                );
              };
              ...
              var o = r(i(1)),
                ...
                s = (function () {
                  function t(t, e) {
                    void 0 === e && (e = {}),
                      (this._src = t),
                      (this._opts = n.assignDeep({}, o.default.DefaultOpts, e));
                  }
                  return (
                ...
                return (
                  ...
                  (e.prototype.load = function (t) {
                    ...
                    if ("string" == typeof t)
                      (e = document.createElement("img")),
                        (i = t),
                        ((a = new URL(i, location.href)).protocol ===
                          location.protocol &&
                  ...
                  (e.prototype.resize = function (t, e, i) {
                    var r = this,
                      ...
                      n = r._context,
                      s = r.image;
                    (this._width = o.width = t),
                      (this._height = o.height = e),
                      n.scale(i, i),
                      n.drawImage(s, 0, 0);
                  }),
            ...
            function (t, e, i) {
              ...
              var o = r(i(12)),
                n = r(i(16)),
                s = new (i(17).BasicPipeline)().filter
                  .register("default", function (t, e, i, r) {
                    return r >= 125 && !(t > 250 && e > 250 && i > 250);
                  })
                  .quantizer.register("mmcq", o.default)
                  .generator.register("default", n.default);
              e.default = s;
            },
            function (t, e, i) {
              var r =
              ...
              function a(t, e) {
                for (var i = t.size(); t.size() < e; ) {
                  ...
                  var o = r.split(),
                    ...
                    s = o[1];
                  if (
                    (t.push(n), s && s.count() > 0 && t.push(s), t.size() === i)
                  )
                    break;
                  i = t.size();
                }
              ...
              e.default = function (t, e) {
                ...
                var i = n.default.build(t);
                i.histogram.colorCount;
                var r = new s.default(function (t, e) {
                  return t.count() - e.count();
                });
                r.push(i), a(r, 0.75 * e.colorCount);
                ...
                return (
                  ...
                  (function (t) {
                    for (var e = []; t.size(); ) {
                      var i = t.pop(),
                        r = i.avg();
                      r[0], r[1], r[2], e.push(new o.Swatch(r, i.count()));
                    }
                    return e;
                  })(l)
                );
            ...
            function (t, e, i) {
              ...
              var o = r(i(14)),
                n = (function () {
                  ...
                  return (
                    (t.build = function (e) {
                      var i = new o.default(e, { sigBits: 5 });
                      return new t(
                        i.rmin,
                        i.rmax,
                        i.gmin,
                    ...
                    (t.prototype.volume = function () {
                      if (this._volume < 0) {
                        var t = this.dimension,
                          ...
                          n = t.b1,
                          s = t.b2;
                        this._volume = (i - e + 1) * (o - r + 1) * (s - n + 1);
                      }
                      return this._volume;
                    }),
                    ...
                    (t.prototype.clone = function () {
                      var e = this.histogram,
                        i = this.dimension;
                      return new t(i.r1, i.r2, i.g1, i.g2, i.b1, i.b2, e);
                    }),
                    ...
                    (t.prototype.split = function () {
                      ...
                      var _ = null;
                      if (f === d) {
                        (_ = "r"), (v = new Uint32Array(n + 1));
                        for (var y = o; y <= n; y++) {
                          h = 0;
                          for (var b = s; b <= a; b++)
                            for (var w = l; w <= c; w++) h += e[i(y, b, w)];
                          (p += h), (v[y] = p);
                        }
                      } else if (f === m)
                        for (
                          _ = "g", v = new Uint32Array(a + 1), b = s;
                          b <= a;
                          b++
                        ) {
                          for (h = 0, y = o; y <= n; y++)
                            for (w = l; w <= c; w++) h += e[i(y, b, w)];
                          (p += h), (v[b] = p);
                        }
                      else
                        for (
                          _ = "b", v = new Uint32Array(c + 1), w = l;
                          w <= c;
                          w++
                        ) {
                          for (h = 0, y = o; y <= n; y++)
                            for (b = s; b <= a; b++) h += e[i(y, b, w)];
                          (p += h), (v[w] = p);
                        }
                      for (
                        var x = -1, k = new Uint32Array(v.length), S = 0;
                        S < v.length;
                        S++
                      ) {
                        var $ = v[S];
                      ...
                      return (function (t) {
                        ...
                        for (
                          a <= l
                            ? ((o = Math.min(o - 1, ~~(x + l / 2))),
                              (o = Math.max(0, o)))
                            : ((o = Math.max(r, ~~(x - 1 - a / 2))),
                              (o = Math.min(P.dimension[i], o)));
                          !v[o];

                        )
                          o++;
                        for (var c = k[o]; !c && v[o - 1]; ) c = k[--o];
                        return (
                          (n.dimension[i] = o), (s.dimension[e] = o + 1), [n, s]
                        );
                      })(_);
                    }),
                    t
              ...
              var r = (function () {
                function t(t, e) {
                  ...
                  var o,
                    ...
                    p,
                    d = 8 - i,
                    m = new Uint32Array(1 << (3 * i));
                  (o = s = l = 0), (n = a = c = Number.MAX_VALUE);
                  for (var g = t.length / 4, f = 0; f < g; ) {
                    var v = 4 * f;
                    f++,
                      (u = t[v + 0]),
                      (h = t[v + 1]),
                  ...
                  (this._colorCount = m.reduce(function (t, e) {
                    return e > 0 ? t + 1 : t;
                  }, 0)),
                    (this.hist = m),
                    (this.rmax = o),
            ...
            function (t, e, i) {
              ...
              function s(t, e, i, r, o, n, s, a, l, c) {
                var u = null,
                  h = 0;
                return (
                      ...
                      var g = (function (t, e, i, r, o, n, s) {
                        ...
                        return (function () {
                          for (var t = [], e = 0; e < arguments.length; e++)
                            t[e] = arguments[e];
                          for (var i = 0, r = 0, o = 0; o < t.length; o += 2) {
                            var n = t[o],
                              s = t[o + 1];
                            (i += n * s), (r += s);
                          }
              ...
              e.default = function (t, e) {
                  ...
                  a = (function (t, e, i) {
                    ...
                    return (
                      (r.Vibrant = s(
                        ...
                        i.minNormalLuma,
                        i.maxNormalLuma,
                        i.targetVibrantSaturation,
                        i.minVibrantSaturation,
                        1,
                        i,
                      )),
                      (r.LightVibrant = s(
                      ...
                      (r.Muted = s(
                        ...
                        i.minNormalLuma,
                        i.maxNormalLuma,
                        i.targetMutesSaturation,
                        0,
                        i.maxMutesSaturation,
                        i,
                      )),
                      (r.LightMuted = s(
                        r,
                ...
                return (
                  (function (t, e, i) {
                    if (!t.Vibrant && !t.DarkVibrant && !t.LightVibrant) {
                      if (!t.DarkVibrant && t.DarkMuted) {
                        var n = t.DarkMuted.hsl,
                          s = n[0],
                          a = n[1],
                          l = n[2];
                        (l = i.targetDarkLuma),
                          (t.DarkVibrant = new r.Swatch(
                            o.hslToRgb(s, a, l),
                            0,
                          ));
                      }
                      if (!t.LightVibrant && t.LightMuted) {
                        var c = t.LightMuted.hsl;
                        (s = c[0]),
                          (a = c[1]),
                          (l = c[2]),
                          (l = i.targetDarkLuma),
                    ...
                    if (!t.Vibrant && t.DarkVibrant) {
                      var u = t.DarkVibrant.hsl;
                      (s = u[0]),
                        (a = u[1]),
                        (l = u[2]),
                        (l = i.targetNormalLuma),
                        (t.Vibrant = new r.Swatch(o.hslToRgb(s, a, l), 0));
                    } else if (!t.Vibrant && t.LightVibrant) {
                      var h = t.LightVibrant.hsl;
                      (s = h[0]),
                        (a = h[1]),
                        (l = h[2]),
                        (l = i.targetNormalLuma),
                    ...
                    if (!t.DarkVibrant && t.Vibrant) {
                      var p = t.Vibrant.hsl;
                      (s = p[0]),
                        (a = p[1]),
                        (l = p[2]),
                        (l = i.targetDarkLuma),
                        (t.DarkVibrant = new r.Swatch(o.hslToRgb(s, a, l), 0));
                    }
                    if (!t.LightVibrant && t.Vibrant) {
                      var d = t.Vibrant.hsl;
                      (s = d[0]),
                        (a = d[1]),
                        (l = d[2]),
                        (l = i.targetLightLuma),
                        (t.LightVibrant = new r.Swatch(o.hslToRgb(s, a, l), 0));
                    }
                    if (!t.Muted && t.Vibrant) {
                      var m = t.Vibrant.hsl;
                      (s = m[0]),
                        (a = m[1]),
                        (l = m[2]),
                        (l = i.targetMutesSaturation),
                        (t.Muted = new r.Swatch(o.hslToRgb(s, a, l), 0));
                    }
                    if (!t.DarkMuted && t.DarkVibrant) {
                      var g = t.DarkVibrant.hsl;
                      (s = g[0]),
                        (a = g[1]),
                        (l = g[2]),
                        (l = i.targetMutesSaturation),
                        (t.DarkMuted = new r.Swatch(o.hslToRgb(s, a, l), 0));
                    }
                    if (!t.LightMuted && t.LightVibrant) {
                      var f = t.LightVibrant.hsl;
                      (s = f[0]),
                        (a = f[1]),
                        (l = f[2]),
                        (l = i.targetMutesSaturation),
                        (t.LightMuted = new r.Swatch(o.hslToRgb(s, a, l), 0));
                    }
                  })(a, 0, e),
                  a
                );
            ...
            function (t, e, i) {
              ...
              Object.defineProperty(e, "__esModule", { value: !0 }),
                (e.BasicPipeline = e.Stage = void 0);
              var n = i(2),
                s = (function () {
                  function t(t) {
              ...
              var a = (function () {
                function t() {
                  (this.filter = new s(this)),
                    (this.quantizer = new s(this)),
                    (this.generator = new s(this));
                }
                return (
                  (t.prototype._buildProcessTasks = function (t) {
                    var e = this,
                      i = t.filters,
                      r = t.quantizer,
                      o = t.generators;
                    return (
                      1 === o.length &&
                        "*" === o[0] &&
                        (o = this.generator.names()),
                      {
                        filters: i.map(function (t) {
                          return n(e.filter, t);
                        }),
                        quantizer: n(this.quantizer, r),
                        generators: o.map(function (t) {
                          return n(e.generator, t);
                        }),
                      }
                    );
                    function n(t, e) {
                      ...
                      return (
                        "string" == typeof e
                          ? (i = e)
                          : ((i = e.name), (r = e.options)),
                        { name: i, fn: t.get(i), options: r }
                      );
                    }
                  }),
                    ...
                    return r(this, void 0, void 0, function () {
                      ...
                      return o(this, function (o) {
                        switch (o.label) {
                          case 0:
                            return (
                              (i = this._buildProcessTasks(e)),
                              (r = i.filters),
                              (n = i.quantizer),
                              (s = i.generators),
                              [4, this._filterColors(r, t)]
                            );
                          case 1:
                            return (
                              (a = o.sent()), [4, this._generateColors(n, a)]
                            );
                          case 2:
                            return (
                              (l = o.sent()), [4, this._generatePalettes(s, l)]
                            );
                          case 3:
                            return (
                              (c = o.sent()), [2, { colors: l, palettes: c }]
                            );
                        }
                      });
                    });
                  }),
                  (t.prototype._filterColors = function (t, e) {
                  ...
                  (t.prototype._generateColors = function (t, e) {
                    return Promise.resolve(t.fn(e.data, t.options));
                  }),
                  (t.prototype._generatePalettes = function (t, e) {
                    return r(this, void 0, void 0, function () {
                      var i;
                          ...
                          case 1:
                            return (
                              ...
                              [
                                2,
                                Promise.resolve(
                                  i.reduce(function (e, i, r) {
                                    return (e[t[r].name] = i), e;
                                  }, {}),
                                ),
                              ]
                            );
...
const me = (t, e, i) => {
    const r = [t, e, i].map((t) => {
      let e = t;
      return (
        (e /= 255), e <= 0.03928 ? e / 12.92 : ((e + 0.055) / 1.055) ** 2.4
      );
    });
...
de._pipeline.generator.register("default", (t) => {
  t.sort((t, e) => e.population - t.population);
  const e = t[0];
  let i;
  const r = new Map(),
    o = (t, i) => (r.has(t) || r.set(t, ge(e.rgb, i)), r.get(t) > 4.5);
  for (let e = 1; e < t.length && void 0 === i; e++) {
    if (o(t[e].hex, t[e].rgb)) {
      i = t[e].rgb;
      break;
    }
    const r = t[e];
    for (let n = e + 1; n < t.length; n++) {
      ...
      if (
        !(
          Math.abs(r.rgb[0] - e.rgb[0]) +
            Math.abs(r.rgb[1] - e.rgb[1]) +
            Math.abs(r.rgb[2] - e.rgb[2]) >
          150
        ) &&
        o(e.hex, e.rgb)
      ) {
  ...
  return (
    void 0 === i && (i = e.getYiq() < 200 ? [255, 255, 255] : [0, 0, 0]),
    [new e.constructor(i, 0).hex, e.hex]
  );
});
...
const fe = {
    ...
    de: {
      placeholder: { tts: "Text zum Sprechen" },
      label: {
        leave: "Verlassen",
        ungroup: "Teilen",
      ...
      state: { idle: "Pause", unavailable: "Nicht verfügbar" },
      title: { speaker_management: "Wiedergabe auf" },
    },
    fi: {
      placeholder: { tts: "Teksti puheeksi" },
      label: {
        leave: "Jätä",
        ungroup: "Pura ryhmä",
      ...
      state: { idle: "Tauko", unavailable: "Ei käytettävissä" },
      title: { speaker_management: "Ryhmän hallinta" },
    },
    fr: {
    ...
    he: {
      ...
      state: { idle: "לא פעיל", unavailable: "לא זמין" },
      title: { speaker_management: "ניהול קבוצות" },
    },
    hu: {
    ...
    it: {
      placeholder: { tts: "Conversione testo in voce" },
      label: {
        leave: "Lascia",
        ungroup: "Separa",
      ...
      state: { idle: "Inattivo", unavailable: "Non disponibile" },
      title: { speaker_management: "Gestione gruppo" },
    },
    is: {
      placeholder: { tts: "Texti sem á að segja" },
      label: {
        leave: "Yfirgefa",
        ungroup: "Aðskilja",
      ...
      state: { idle: "Aðgerðalaus", unavailable: "Ekki tiltækt" },
      title: { speaker_management: "Stjórnun hópa" },
    },
    no: {
    ...
    pl: {
      placeholder: { tts: "Zamień tekst na mowę" },
      label: {
        leave: "Opuść",
        ungroup: "Usuń grupę",
      ...
      state: { idle: "brak aktywności", unavailable: "niedostępny" },
      title: { speaker_management: "Zarządzanie grupą" },
    },
    sv: {
      placeholder: { tts: "Text till tal" },
      label: {
        leave: "Lämna",
        ungroup: "Avgruppera",
      ...
      state: { idle: "Inaktiv", unavailable: "Otillgänglig" },
      title: { speaker_management: "Gruppstyrning" },
    },
    uk: {
    ...
    ru: {
      placeholder: { tts: "Преобразование текста в речь" },
      label: {
        leave: "Покинуть",
      ...
      state: { idle: "Бездействие", unavailable: "Недоступен" },
      title: { speaker_management: "Управление группой" },
    },
    es: {
      placeholder: { tts: "Texto a voz" },
      label: {
        leave: "Salir",
        ungroup: "Desagrupar",
      ...
      state: { idle: "Inactivo", unavailable: "No disponible" },
      title: { speaker_management: "Gestión de grupo" },
    },
    zh: {
      placeholder: { tts: "播放文本" },
      label: {
        leave: "退出",
        ungroup: "取消组合",
        group_all: "组合全部",
      ...
      state: { idle: "空闲", unavailable: "不可用" },
      title: { speaker_management: "组合管理" },
    },
    sk: {
      placeholder: { tts: "Prevod textu na reč" },
      label: {
        leave: "Odísť",
      ...
      state: { idle: "Nečinný", unavailable: "Nedostupné" },
      title: { speaker_management: "Manažment skupiny" },
    },
    ca: {
      placeholder: { tts: "Text a veu" },
      label: {
        leave: "Sortir",
        ungroup: "Desagrupar",
      ...
      state: { idle: "Inactiu", unavailable: "No disponible" },
      title: { speaker_management: "Gestió del grup" },
    },
    nl: {
      placeholder: { tts: "Tekst naar spraak" },
      label: {
        leave: "Verlaten",
      ...
      state: { idle: "Inactief", unavailable: "Niet beschikbaar" },
      title: { speaker_management: "Groepsbeheer" },
    },
    pt: {
      placeholder: { tts: "Texto para fala" },
      label: {
        leave: "Sair",
        ungroup: "Desagrupar",
      ...
      state: { idle: "Ocioso", unavailable: "Indisponível" },
      title: { speaker_management: "Gerenciamento de grupo" },
    },
    cs: {
      placeholder: { tts: "Převod textu na řeč" },
      label: {
        leave: "Opustit",
        ungroup: "Zrušit seskupení",
        group_all: "Seskupit vše",
      ...
      state: { idle: "Nečinný", unavailable: "Nedostupné" },
      title: { speaker_management: "Správa skupiny" },
    },
  },
  ve = (t, e) => e.split(".").reduce((t, e) => (t && t[e]) || null, t),
  _e = (t, e, i, r = "unknown") => {
    const o = t.selectedLanguage || t.language,
      n = o.split("-")[0];
    return (
      (fe[o] && ve(fe[o], e)) ||
      (t.resources[o] && i && t.resources[o][i]) ||
      (fe[n] && ve(fe[n], e)) ||
      ve(fe.en, e) ||
      r
    );
...
t([Y({ attribute: !1 })], ye.prototype, "checked", void 0),
  t([Y({ attribute: !1 })], ye.prototype, "disabled", void 0),
  t([Y({ attribute: !1 })], ye.prototype, "label", void 0),
  (ye = t([J("mmp-checkbox")], ye));
let be = class extends ot {
  render() {
    return I`
      <mmp-checkbox
      ...
      >
        ${this.item.name} ${
          this.master
            ? I`<span class="master">(${_e(this.hass, "label.master")})</span>`
            : ""
        }
      </mmp-checkbox>
    `;
...
t([Y({ attribute: !1 })], be.prototype, "hass", void 0),
  t([Y({ attribute: !1 })], be.prototype, "item", void 0),
  t([Y({ attribute: !1 })], be.prototype, "checked", void 0),
  t([Y({ attribute: !1 })], be.prototype, "disabled", void 0),
  t([Y({ attribute: !1 })], be.prototype, "master", void 0),
  (be = t([J("mmp-group-item")], be));
let we = class extends ot {
  render() {
    return I`
      <div class="container">
...
let xe = class extends ot {
  ...
  handleGroupChange(t) {
    const { entity: e, checked: i } = t.detail;
    this.player.handleGroupChange(t, e, i);
  }
  render() {
    if (!this.visible) return I``;
    const { group: t, isMaster: e, isGrouped: i } = this,
      { id: r } = this.player;
    return I`
      <div class="mmp-group-list">
        <span class="mmp-group-list__title">${_e(
          this.hass,
          "title.speaker_management",
        )}</span>
        ${this.entities.map((t) => this.renderItem(t, r))}
        <div class="mmp-group-list__buttons">
          <mmp-button raised ?disabled=${!i} @click=${(t) =>
            this.player.handleGroupChange(t, r, !1)}>
            <span>${_e(this.hass, "label.leave")}</span>
          </mmp-button>
          ${
            i && e
              ? I`
                <mmp-button raised @click=${(e) =>
                  this.player.handleGroupChange(e, t, !1)}>
...
t([Y({ attribute: !1 })], xe.prototype, "hass", void 0),
  t([Y({ attribute: !1 })], xe.prototype, "entities", void 0),
  t([Y({ attribute: !1 })], xe.prototype, "player", void 0),
  t([Y({ attribute: !1 })], xe.prototype, "visible", void 0),
  (xe = t([J("mmp-group-list")], xe));
customElements.define(
  "mmp-dropdown",
  class extends ot {
    ...
    firstUpdated() {
      const t = this.shadowRoot.querySelector("#menu"),
        e = this.shadowRoot.querySelector("#button");
      t.anchor = e;
    }
    render() {
      return I`
        ...
        <mwc-menu
          ...
          ${this.items.map(
            ...
            <mwc-list-item value=${t.id || t.name}>
              ...
              ${
                t.name
                  ? I`<span class='mmp-dropdown__item__label'>${t.name}</span>`
                  : ""
              }
            </mwc-list-item>`,
          )}
    ...
    toggleMenu() {
      const t = this.shadowRoot.querySelector("#menu");
      (t.open = !t.open), (this.isOpen = t.open);
    }
    static get styles() {
      return [
        ae,
...
customElements.define(
  ...
  class extends ot {
    ...
    handleShortcut(t, e) {
      const { type: i, id: r, data: o } = e || t.detail;
      if ("source" === i) return this.player.setSource(t, r);
      if ("service" === i) return this.player.toggleService(t, r, o);
      if ("script" === i) return this.player.toggleScript(t, r, o);
      if ("sound_mode" === i) return this.player.setSoundMode(t, r);
      const n = { media_content_type: i, media_content_id: r };
      this.player.setMedia(t, n);
    }
    shortcutStyle(t) {
      return {
...
customElements.define(
  ...
  class extends ot {
    ...
    handleTts(t) {
      const { config: e, message: i } = this,
        r = {
          message: i,
          entity_id: e.entity_id || this.player.id,
          ...("group" === e.entity_id && { entity_id: this.player.group }),
          ...e.data,
        };
      switch ((e.language && (r.language = e.language), e.platform)) {
        case "alexa":
          this.hass.callService("notify", "alexa_media", {
            message: i,
            data: { type: e.type || "tts", ...e.data },
            target: r.entity_id,
          });
          break;
        case "sonos":
          this.hass.callService("script", "sonos_say", {
            sonos_entity: r.entity_id,
            volume: e.volume || 0.5,
            message: i,
            ...e.data,
          });
          break;
        case "webos":
          this.hass.callService("notify", r.entity_id.split(".").slice(-1)[0], {
            message: i,
            ...e.data,
          });
          break;
        case "ga":
          ...
          break;
        case "service": {
          const [t, o] = (e.data.service || "").split("."),
            n = {
              [e.data.message_field || "message"]: i,
              entity_id: r.entity_id,
              ...(e.language ? { language: r.language } : {}),
              ...(e.data.service_data || {}),
            };
          this.hass.callService(t, o, n);
          break;
        }
        default:
          this.hass.callService("tts", `${e.platform}_say`, r);
      }
...
var ke = (t) => {
  let e = Math.abs(parseInt("" + (t % 60), 10)),
    i = Math.abs(parseInt("" + ((t / 60) % 60), 10)),
    r = Math.abs(parseInt("" + ((t / 3600) % 24), 10));
  return (
    (r = r < 10 ? `0${r}` : r),
    (i = i < 10 ? `0${i}` : i),
    (e = e < 10 ? `0${e}` : e),
...
customElements.define(
  ...
  class extends ot {
    ...
    get classes() {
      return at({ transiting: !this.seekProgress, seeking: this.seekProgress });
    }
    render() {
      return I`
    ...
    progressBarStyle() {
      return ct({
        width:
          ((this.seekProgress || this.progress) / this.duration) * 100 + "%",
      });
    }
    trackProgress() {
    ...
    handleSeek(t) {
      ...
      const e = t.offsetX || t.changedTouches[0].pageX - this.offset,
        i = this.calcProgress(e);
      this.player.seek(t, i);
    }
    disconnectedCallback() {
...
let Se = class extends ot {
  get source() {
    return this.player.source;
  }
  get alternatives() {
    return this.player.sources.map((t) => ({ name: t, id: t, type: "source" }));
  }
  render() {
    return I`
      <mmp-dropdown
...
t([Y({ attribute: !1 })], Se.prototype, "player", void 0),
  t([Y({ attribute: !1 })], Se.prototype, "icon", void 0),
  (Se = t([J("mmp-source-menu")], Se));
let $e = class extends ot {
  constructor() {
    super(...arguments), (this.selected = void 0);
  }
  get mode() {
...
t([Y({ attribute: !1 })], $e.prototype, "player", void 0),
  t([Y({ attribute: !1 })], $e.prototype, "icon", void 0),
  t([K()], $e.prototype, "selected", void 0),
  ($e = t([J("mmp-sound-menu")], $e));
customElements.define(
  "mmp-media-controls",
  class extends ot {
    static get properties() {
    ...
    renderRepeatButton() {
      if (!this.showRepeat) return I``;
      const t = [Vt.ONE, Vt.ALL].includes(this.player.repeat);
      return I`
    ...
    renderVolControls(t) {
      const e = this.config.volume_stateless
        ...
        r = !this.config.hide.volume_level;
      return I`
      <div class=${i}>
        ${e}
      ...
      ${
        ...
        <ha-icon-button
          ...
          .icon=${t.play_pause ? Bt[this.player.isPlaying] : Bt.true}>
            <ha-icon .icon=${
              t.play_pause ? Bt[this.player.isPlaying] : Bt.true
            }></ha-icon>
        </ha-icon-button>
      `
      }
    ...
    renderJumpForwardButton() {
      return this.config.hide.jump || !this.player.hasProgress
        ? I``
        : I`
      <ha-icon-button
...
customElements.define(
  ...
  class extends ot {
    ...
    get icon() {
      return this.config.speaker_group.icon || Lt;
    }
    get showGroupButton() {
      return (
        this.config.speaker_group.entities.length > 0 &&
        !this.config.hide.group_button
      );
    }
    get showPowerButton() {
    ...
    render() {
      ...
      ${
        this.hasControls
          ? I` <mmp-media-controls .player=${this.player} .config=${this.config}> </mmp-media-controls> `
          : ""
      }
      ${
        this.hasSource
          ? I` <mmp-source-menu .player=${this.player} .icon=${
              this.sourceSize
    ...
    get renderIdleView() {
      return this.player.isPaused
        ? I` <ha-icon-button .icon=${It[this.player.isPlaying]} @click=${(t) =>
            this.player.playPause(t)}>
        <ha-icon .icon=${It[this.player.isPlaying]}></ha-icon>
      </ha-icon-button>`
        : this.showLabel
        ? I` <span class="label ellipsis"> ${_e(
            this.hass,
            "state.idle",
            "state.media_player.idle",
          )} </span> `
        : I``;
    }
    static get styles() {
...
let Pe = class extends ot {
  ...
  set hass(t) {
    ...
    if (
      ...
      e &&
        this.entity !== e &&
        ((this.entity = e),
        (this.player = new ne(t, this.config, e)),
      ...
      e &&
        ...
        ((this.groupMgmtEntity = e),
        (this.groupMgmtPlayer = new ne(t, this.config, e)));
    }
  }
  get hass() {
    return this._hass;
  ...
  static async getConfigElement() {
    return (
      ...
      document.createElement("mini-media-player-editor")
    );
  }
  static get styles() {
    return [ae, se];
  ...
  shouldUpdate(t) {
    return (
      ...
      t.has("player") && "material" === this.config.artwork && this.setColors(),
      Zt.some((e) => t.has(e)) && Boolean(this.player)
    );
  }
  firstUpdated() {
    new Ot((t) => {
            ...
            this._resizeTimer ||
              ...
              (this._resizeTimer = setTimeout(() => {
                (this._resizeTimer = void 0),
                  this._resizeEntry &&
                    (this.computeRect(this._resizeEntry), this.measureCard());
              }, 250))),
            (this._resizeEntry = t);
        });
      });
      ...
      >
        ...
        <div class="mmp-player">
          ...
          <div class="mmp-player__adds">
            ${
              !t.collapse && this.player.isActive
                ? I`
            ...
            <mmp-shortcuts .player=${this.player} .shortcuts=${
              t.shortcuts
            }> </mmp-shortcuts>
            ${
              t.tts
                ? I` <mmp-tts .config=${t.tts} .hass=${this.hass} .player=${this.player}> </mmp-tts> `
                : ""
            }
            <mmp-group-list
              .hass=${this.hass}
  ...
  computeClasses({ config: t } = this) {
    return at({
      ...
      "--bg": t.background || !1,
      "--group": t.group,
      "--more-info": "none" !== t.tap_action.action,
  ...
  renderArtwork() {
    ...
    const t = {
      ...
      e = {
        ...
        width: "material" === this.config.artwork ? `${this.cardHeight}px` : "",
      };
    return I` <div class="cover" style=${ct(t)}></div>
      ${
        this.prevThumbnail &&
        I` <div class="cover --prev" style=${ct(e)}></div> `
      }`;
  }
  renderGradient() {
    ...
    return I`<div class="cover-gradient" style=${ct(t)}></div>`;
  }
  renderBackground() {
    if (this.config.background)
      return I`
      <div class="cover --bg" style=${ct({
  ...
  handlePopup(t) {
    t.stopPropagation(),
      le(this, this._hass, this.config, this.config.tap_action, this.player.id);
  }
  renderIcon() {
    ...
    if (null != this.config.icon_image)
      return I` <div class="entity__icon">
        <img src="${this.config.icon_image}" height="100%" />
      </div>`;
    const t = !this.config.hide.icon_state && this.player.isActive;
    return I` <div class="entity__icon" ?color=${t}>
      <ha-state-icon
        .hass=${this.hass}
  ...
  renderEntityName() {
    if (!this.config.hide.name)
      return I` <div class="entity__info__name">${
        this.name
      } ${this.speakerCount()}</div>`;
  }
  renderMediaInfo() {
    ...
    >
      ...
      ${t.map(
        (t) => I`<span class=${`attr__${t.attr}`}>${t.prefix + t.text}</span>`,
      )}
    </div>`;
  }
  speakerCount() {
  ...
  computeStyles() {
    ...
    return ct(
      Object.assign(
        Object.assign({}, t && { "--mmp-unit": 40 * t + "px" }),
        this.foregroundColor &&
          this.player.isActive && {
  ...
  measureCard() {
    ...
    e && (this.cardHeight = e.offsetHeight);
  }
  computeOverflow() {
    var t;
    const e =
      null === (t = this.shadowRoot) || void 0 === t
        ? void 0
        : t.querySelector(".marquee");
    if (e && e.parentNode) {
      const t = e.clientWidth > e.parentNode.clientWidth;
      this.overflow =
        t && this.player.isActive ? 7.5 + e.clientWidth / 50 : void 0;
    }
  }
  computeRect(t) {
    if ("contentRect" in t) {
      const { left: e, width: i } = t.contentRect;
      this.break = i + 2 * e < 390;
    } else {
      const { left: e, width: i } = t.getBoundingClientRect();
      this.break = i + 2 * e < 390;
    }
  }
  computeRTL(t) {
  ...
  updateIdleStatus() {
    ...
    const i =
      null ===
        (e =
          null === (t = this.config) || void 0 === t ? void 0 : t.idle_view) ||
      void 0 === e
        ? void 0
        : e.after;
    if (!i) return;
    this._idleTracker && clearTimeout(this._idleTracker);
    const r = (Date.now() - new Date(this.player.updatedAt).getTime()) / 1e3;
    this._idleTracker = setTimeout(
      () => {
        (this.idle = this.player.checkIdleAfter(i)),
          (this.player.idle = this.idle),
          (this._idleTracker = void 0);
      },
      1e3 * (60 * i - r),
    );
  }
  ...
  async setColors() {
    if (this.player.picture !== this.picture) {
      if (!this.player.picture)
        return (this.foregroundColor = ""), void (this.backgroundColor = "");
      try {
        [this.foregroundColor, this.backgroundColor] = await (async (t) =>
          new de(t, { colorCount: 16 }).getPalette())(this.player.picture);
      } catch (t) {
...
t([Y({ attribute: !1 })], Pe.prototype, "hass", null),
  t([K()], Pe.prototype, "_overflow", void 0),
  t([K()], Pe.prototype, "initial", void 0),
  t([K()], Pe.prototype, "picture", void 0),
  t([K()], Pe.prototype, "thumbnail", void 0),
  t([K()], Pe.prototype, "prevThumbnail", void 0),
  t([K()], Pe.prototype, "edit", void 0),
  t([K()], Pe.prototype, "rtl", void 0),
  t([K()], Pe.prototype, "cardHeight", void 0),
  t([K()], Pe.prototype, "foregroundColor", void 0),
  t([K()], Pe.prototype, "backgroundColor", void 0),
  t([K()], Pe.prototype, "config", void 0),
  t([K()], Pe.prototype, "_hass", void 0),
  t([K()], Pe.prototype, "entity", void 0),
  t([K()], Pe.prototype, "player", void 0),
  t([K()], Pe.prototype, "idle", void 0),
  t([K()], Pe.prototype, "groupMgmtPlayer", void 0),
  t([K()], Pe.prototype, "groupMgmtEntity", void 0),
  t([K()], Pe.prototype, "break", void 0),
  t([K()], Pe.prototype, "_resizeEntry", void 0),
  t([K()], Pe.prototype, "_resizeTimer", void 0),
  t([K()], Pe.prototype, "_idleTracker", void 0),
  (Pe = t([J("mini-media-player")], Pe)),
...
const Ce = ["cover", "full-cover", "material", "cover-fit", "none"],
  Me = ["icon", "full"],
  Ee = ["icon", "full"],
  Te = ["short", "scroll"],
  Oe = ["play_pause", "stop", "play_stop", "next"],
  Ae = (t, e = !1) => {
    const i = t.map((t) => ({ name: t, id: t }));
    return e && i.push({ name: "Default", id: void 0 }), i;
  };
class Ve extends ot {
  static get styles() {
    return [
  ...
  setConfig(t) {
    this._config = Object.assign({}, re, t);
  }
  ...
  render() {
    ...
    const t = this.getMediaPlayerEntities.map((t) => ({ name: t, id: t }));
    return I`
      <div class="card-config">
        <div class="overall-config">
          ...
          <mmp-dropdown
            ...
            @change=${({ detail: t }) =>
              this.valueChanged({
                target: { configValue: "entity", value: t.id },
              })}
            .items=${t}
            .label=${"Select entity"}
          ...
          <div class="editor-side-by-side">
            <div>
              ...
              <mmp-dropdown
                ...
                @change=${({ detail: t }) =>
                  this.valueChanged({
                    target: { configValue: "artwork", value: t.id },
                  })}
                .items=${Ae(Ce, !0)}
                .label=${"Default"}
            ...
            <div>
              ...
              <mmp-dropdown
                ...
                @change=${({ detail: t }) =>
                  this.valueChanged({
                    target: { configValue: "source", value: t.id },
                  })}
                .items=${Ae(Me, !0)}
                .label=${"Default"}
            ...
            <div>
              ...
              <mmp-dropdown
                ...
                @change=${({ detail: t }) =>
                  this.valueChanged({
                    target: { configValue: "sound_mode", value: t.id },
                  })}
                .items=${Ae(Ee, !0)}
                .label=${"Default"}
          ...
          <div class="editor-side-by-side">
            <div>
              ...
              <mmp-dropdown
                ...
                @change=${({ detail: t }) =>
                  this.valueChanged({
                    target: { configValue: "info", value: t.id },
                  })}
                .items=${Ae(Te, !0)}
                .label=${"Default"}
            ...
            <div>
              ...
              <mmp-dropdown
                ...
                @change=${({ detail: t }) =>
                  this.valueChanged({
                    target: { configValue: "replace_mute", value: t.id },
                  })}
                .items=${Ae(Oe, !0)}
                .label=${"Default"}
  ...
  valueChanged(t) {
    ...
    this[`_${e.configValue}`] !== e.value &&
      ...
      ((t, e, i = {}, r = {}) => {
        ...
        (o.detail = i), t.dispatchEvent(o);
      })(this, "config-changed", { config: this._config }));
  }
}
customElements.define("mini-media-player-editor", Ve);
var Ne = Object.freeze({ __proto__: null, default: Ve });
