...
from .const import ILLUMINANCE_SENSOR_ENTITY_PREFIX, ILLUMINANCE_SENSOR_PREFIX


class IlluminanceSensor(AutoEntity[SensorEntity, SensorDeviceClass], SensorEntity):
