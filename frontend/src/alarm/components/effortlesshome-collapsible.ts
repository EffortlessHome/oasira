...
class effortlesshomeCollabsibleGroup extends LitElement {
  static get styles() {
    return css`
      :host {
        display: block;
...
class effortlesshomeCollabsibleHeader extends LitElement {
...
class effortlesshomeCollabsibleBody extends LitElement {
  static get styles() {
    return css`
      :host {
        display: block;
