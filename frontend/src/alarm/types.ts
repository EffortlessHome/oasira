...
export type effortlesshomeModeConfig = {
  enabled: boolean;
  exit_time: number;
  entry_time: number;
  trigger_time: number;
...
export type effortlesshomeConfig = {
  code_arm_required: boolean;
  code_disarm_required: boolean;
...
export type effortlesshomeSensor = {
  entity_id: string;
  type: ESensorTypes;
  modes: EArmModes[];
...
export type effortlesshomeUser = {
  user_id?: string;
  name: string;
  enabled: boolean;
  code: string;
...
export interface effortlesshomeAutomation {
...
export type effortlesshomeArea = {
  area_id: string;
  name: string;
  enabled: boolean;
  modes: Record<EArmModes, effortlesshomeModeConfig>;
};
