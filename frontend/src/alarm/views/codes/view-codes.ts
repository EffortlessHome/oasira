...
import { effortlesshomeConfig, Dictionary, effortlesshomeUser, HomeAssistant } from '../../types';
...
export class AlarmViewCodes extends SubscribeMixin(LitElement) {
  ...
  @property()
  data?: Partial<effortlesshomeConfig>;

  @property()
  users: Dictionary<effortlesshomeUser> = {};
  ...
  saveData(changes: Partial<effortlesshomeConfig>) {
    if (!this.hass) return;
