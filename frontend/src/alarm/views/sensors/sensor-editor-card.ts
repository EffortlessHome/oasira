...
import { effortlesshomeSensor, EArmModes, Dictionary, effortlesshomeArea, SensorGroup, HomeAssistant } from '../../types';
...
import { Option } from '../../components/effortlesshome-select';
...
export class SensorEditorCard extends SubscribeMixin(LitElement) {
  ...
  private _SetData(data: Partial<effortlesshomeSensor>) {
    if (!this.data) return;
