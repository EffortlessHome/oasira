...
import { effortlesshomeConfig, Dictionary, effortlesshomeArea, effortlesshomeSensor, effortlesshomeAutomation, HomeAssistant } from '../../types';
...
import { TableData, TableColumn } from '../../components/effortlesshome-table';
...
export class AreaConfigCard extends SubscribeMixin(LitElement) {
  ...
  @property() config?: effortlesshomeConfig;
  @property() areas: Dictionary<effortlesshomeArea> = {};
  @property() sensors: Dictionary<effortlesshomeSensor> = {};
  @property() automations: Dictionary<effortlesshomeAutomation> = {};
