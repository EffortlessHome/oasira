...
import { effortlesshomeModeConfig, effortlesshomeConfig, EArmModes, Dictionary, effortlesshomeArea, effortlesshomeSensor, HomeAssistant } from '../../types';
...
export class AlarmModeCard extends SubscribeMixin(LitElement) {
  ...
  @property()
  data!: Record<EArmModes, effortlesshomeModeConfig>;
  ...
  private saveData(mode: EArmModes, update: Partial<effortlesshomeModeConfig>) {
    const DefaultMode: effortlesshomeModeConfig = {
      enabled: false,
      exit_time: 0,
      entry_time: 0,
      trigger_time: 0,
